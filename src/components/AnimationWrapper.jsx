...
const AnimationWrapper = ({ text, animateRef, children }) => {
  return (
    <Box className="anim-parent" w={["100%", null, null, "80%", "60%"]}>
      <Box className="anim-child" ref={animateRef}>
        {children}
        <Center
          className="anim-box"
          rounded="lg"
        ...
        >
          ...
          <Text className="anim-box-text" fontSize="2xl" color="white">
            {text}
          </Text>
        </Center>
      </Box>
